    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('get-categories') }}"> All Categories </a>
                <a class="dropdown-item" href="{{ URL::to('post-blog-form') }}"> Create blog</a>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('post-blog-form') }}"> Create blog</a>
                <a class="dropdown-item" href="{{ URL::to('get-all-posts') }}"> Get ALl posts </a>
